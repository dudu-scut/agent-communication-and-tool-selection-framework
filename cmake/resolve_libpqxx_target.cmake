function(agent_rpc_resolve_libpqxx_target output_variable)
    ...
    if(CMAKE_SYSTEM_NAME STREQUAL "Linux" AND EXISTS "/etc/os-release")
        file(STRINGS "/etc/os-release" _agent_rpc_os_release_lines)
        foreach(_agent_rpc_os_release_line IN LISTS _agent_rpc_os_release_lines)
            if(_agent_rpc_os_release_line MATCHES "^ID=\"?ubuntu\"?$")
                set(_agent_rpc_ubuntu_match ON)
            endif()
            if(_agent_rpc_os_release_line MATCHES "^VERSION_ID=\"?26\\.04\"?$")
                set(_agent_rpc_ubuntu_version_match ON)
            endif()
        endforeach()
